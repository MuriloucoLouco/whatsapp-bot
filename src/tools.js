...
function get_piada() {
  const piada = PIADAS[Math.floor(Math.random() * PIADAS_LENGTH)];
  return piada;
}

function get_luiz() {
  return LUIZ[Math.floor(Math.random() * LUIZ_LENGTH)];
}
